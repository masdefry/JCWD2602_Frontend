...
a. Komponen React mengirimkan actions ke Redux, yang kemudian memperbarui state.
...
b. Penggunaan Link dari next/link bersifat sangat baik untuk SEO performance, dikarenakan link perpindahan page dapat dideteksi oleh crawler dan memiliki behavior SPA
...
b. useRef adalah hook dalam React yang digunakan untuk mengakses dan memanipulasi elemen DOM.
...
d. Gunakan useState untuk menginisialisasi state count dan setCount, dan gunakan setCount untuk mengubah state saat tombol ditekan.
